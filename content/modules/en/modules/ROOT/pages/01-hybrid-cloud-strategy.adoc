...
image::01-hybrid-strategy.png[Hybrid cloud strategy — hub and spokes,960]
...
| ACM fleet UI | `charts/all/acm-hub-spoke/` |
| Hub app-of-apps | `charts/region/hub/templates/component-applications.yaml` |
|===
