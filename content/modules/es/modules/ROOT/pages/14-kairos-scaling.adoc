...
Abre Kairos Console desde el menú OpenShift, localiza recomendaciones pendientes en namespaces de `pass:[%USER_NAME%]` y aprueba o debate trade-offs con el facilitador. Ejecuta `oc get smartscalingpolicy -A` para correlacionar CRDs con acciones UI.
