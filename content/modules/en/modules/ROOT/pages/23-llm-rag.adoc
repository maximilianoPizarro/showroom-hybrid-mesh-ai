...
| Developer Hub — Lightspeed | `https://developer-hub.{hub_domain}` (catalog → Ask) | Workshop user
| Workshop APIs — LLM route | `https://workshop-apis.{hub_domain}/llm` | Kuadrant API key (module 20)
