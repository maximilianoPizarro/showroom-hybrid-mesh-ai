...
image::15-observability.png[Multicluster observability — metrics, logs, traces, and IE Kafka dashboards,960]
...
| Application traces
| OpenTelemetry (`components/opentelemetry/`) + Jaeger/Tempo
