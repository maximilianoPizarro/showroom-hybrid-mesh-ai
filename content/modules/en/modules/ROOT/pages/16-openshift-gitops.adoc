...
| Gitea | `https://gitea-gitea.{hub_domain}` | Workshop user (*Gitea admin (facilitator):* `gitea_admin` / `openshift`)
| Argo CD (hub) | `https://console-openshift-console.{hub_domain}/k8s/ns/openshift-gitops/applications.argoproj.io~v1alpha1~Application` | Workshop user
