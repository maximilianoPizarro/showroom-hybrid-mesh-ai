...
| Showroom | `https://showroom-showroom.{hub_domain}/?USER_NAME=pass:[%USER_NAME%]` | After registration
| OpenShift Console (hub) | `https://console-openshift-console.{hub_domain}` | Workshop user
| ACM fleet overview | `https://console-openshift-console.{hub_domain}/multicloud/infrastructure/clusters` | Workshop user
|===
