...
| OpenShift Console — Security | `https://console-openshift-console.{hub_domain}/security` | Workshop user
| Kiali (mesh policies) | `https://kiali-openshift-cluster-observability-operator.{hub_domain}` | OpenShift OAuth
|===
