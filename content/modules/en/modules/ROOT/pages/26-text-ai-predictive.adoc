...
[source,yaml]
----
# POST https://ai-gateway.%HUB_DOMAIN%/v1/chat/completions
...
* link:https://www.redhat.com/en/blog[Red Hat blog — AI topics]
...
| MaaS playground | link:https://maas-rhdp.apps.maas.redhatworkshops.io/v1/models[MaaS models endpoint] | Facilitator token (401 without auth)
