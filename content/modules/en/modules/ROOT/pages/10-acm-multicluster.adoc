...
image::10-acm-multicluster.png[ACM multicluster fleet — hub governing east and west OpenShift spokes,960]
...
| Modules 16, 13 — same CRDs in `components/acm-hub-spoke/`
