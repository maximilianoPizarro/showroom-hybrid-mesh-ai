...
image::05-cases-roadmap.png[Customer cases and workshop roadmap,960]
...
| Registro (inicio Parte B) | link:https://workshop-registration.%HUB_DOMAIN%/[Registro (inicio Parte B)] | Email → %USER_NAME%
| Showroom | link:https://showroom-showroom.%HUB_DOMAIN%/?USER_NAME=%USER_NAME%[Showroom] | Tras redirect
| Developer Hub — demos Plan B | link:https://developer-hub.%HUB_DOMAIN%/catalog/default/system/hybrid-mesh-shared-demos[Developer Hub — demos Plan B] | Usuario taller
| Demo Industrial Edge | link:https://industrial-edge.%HUB_DOMAIN%[Demo Industrial Edge] | Pública (sin login)
| Vista previa NeuroFace | link:https://neuroface.%HUB_DOMAIN%[Vista previa NeuroFace] | Pública (sin login)
|===
